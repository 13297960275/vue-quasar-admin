  ...
  <q-layout :view="view">
    <q-layout-header v-model="header" :reveal="headerReveal">
      <q-toolbar :inverted="$q.theme === 'ios'">
        ...
        <q-btn flat round :icon="shrinkMenu?'keyboard_arrow_right':'keyboard_arrow_left'"
          @click="shrinkMenu = !shrinkMenu" /> &nbsp;&nbsp;&nbsp;
        ...
        <q-btn flat round @click="toggleFullscreen()"
          :icon="$q.fullscreen.isActive ? 'fullscreen_exit' : 'fullscreen'" />
        <q-btn flat round icon="menu" @click="right = !right" aria-label="Toggle menu on right side" />
      </q-toolbar>
      <tags-view></tags-view>
      <q-slide-transition>
        <fty-module-tabs v-show="tabsShow" :module-list="moduleList" :current-module="currentModule"
          @select="selectModuleTab"></fty-module-tabs>
      </q-slide-transition>
    ...
    <q-layout-drawer side="left" v-model="left" :overlay="leftOverlay" :behavior="leftBehavior"
      :breakpoint="leftBreakpoint" :content-style="{width:shrinkMenu?'60px':'250px'}" content-class="bg-grey-3">
    ...
    <q-layout-drawer side="right" v-model="right" :overlay="rightOverlay" :behavior="rightBehavior"
      :breakpoint="rightBreakpoint" :content-class="$q.theme === 'mat' ? 'bg-grey-3' : null"
      :content-style="{fontSize: '16px',width:'400px'}">
      <q-scroll-area class="fit">
        ...
        <div class="row no-wrap justify-center q-mt-sm">
          <div class="col gutter-xs q-pr-xs" style="max-width: 180px;">
            <div>
              <q-input type="number" align="right" prefix="Bkpt" placeholder="Bkpt" :value="leftBreakpoint"
                @change="v => leftBreakpoint = v" class="no-margin" />
            </div>
          </div>
          <div class="col gutter-xs" style="max-width: 180px;">
            <div>
              <q-input type="number" align="right" prefix="Bkpt" placeholder="Bkpt" :value="rightBreakpoint"
                @change="v => rightBreakpoint = v" class="no-margin" />
            </div>
          </div>
        </div>
